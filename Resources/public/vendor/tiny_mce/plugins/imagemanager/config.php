<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '/media'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../uploads/media'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['ExternalAuthenticator.secret_key'] = "loremipsumthatitthatalalk#sasdlsadlmsadbakdjsakdjaskdaksj";
