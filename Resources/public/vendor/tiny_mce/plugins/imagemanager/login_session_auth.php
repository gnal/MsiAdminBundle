<?php
	...
	// Some settings
	$msg = "";
	$username = "administration advertisement bad not to be used";
	$password = "#laksdlkasd####alkasdlsmdlmasd#####2lalala##3salalalzmzmaMausb"; // Change the password to something suitable
